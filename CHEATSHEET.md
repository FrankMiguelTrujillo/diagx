...
Postgres : El término 'Postgres' no se reconoce como nombre de un cmdlet, función, archivo de script o programa 
...
+ Postgres local (Docker): usuario=postgres, password=diagx123, db=diag ...
+ ~~~~~~~~
